...
client.on("message", (message) => {
    ...
    } else if (message.content.startsWith("Hey bot, do we like helo?")) {
        message.channel.send("Yes, we like helo");
    } else if (message.content.startsWith("Hey bot, do we like nervous?")){
        message.channel.send("Yes, we like nervous")
    } else if (message.content.startsWith("Hey bot, do we like people?")){
        message.channel.send("Yes, we like everyone")
    } else if (message.content.startsWith("Hey bot, do we like craig?")){
        message.channel.send("No, have you seen my source code?")
    } else if (message.content.startsWith("Hey bot, respond to me")){
        message.channel.send("No")
    } else if (message.content.startsWith("Hey bot, c++ is lame")){
        message.channel.send("You're not wrong")
    } else if (message.content.startsWith("Hey bot, use a better language")){
